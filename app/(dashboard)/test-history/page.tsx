                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="과정총괄테스트">과정총괄테스트</option>
                        <option value="내용암기테스트">내용암기테스트</option>
                        <option value="단원테스트">단원테스트</option>
                        <option value="모의고사">모의고사</option>
                        <option value="서술형평가">서술형평가</option>
                        <option value="수학경시대회">수학경시대회</option>
                        <option value="오답테스트">오답테스트</option>
                        <option value="내신기출유사">내신기출유사</option>
                        <option value="내신기출">내신기출</option>
                      </select>
                    </div>
                  </div>
                  <div className="mt-4">
