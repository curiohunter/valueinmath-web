...
import { BookOpen, FileText, UserCheck, ClipboardCheck, Target } from "lucide-react"
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {log.date
                  ? format(new Date(log.date), "yyyy년 M월 d일 (E)", {
                      locale: ko,
                    })
                  : "날짜 미정"}
              </p>
          ...
          <div className="grid grid-cols-5 gap-3 text-sm">
            ...
            <div className="space-y-2">
              ...
              {log.attendance_status ? (
                <span
                  className={`inline-flex items-center justify-center w-full px-2 py-1.5 text-xs font-semibold rounded-full border-2 ${scoreColor(log.attendance_status)}`}
                >
            ...
            <div className="space-y-2">
              ...
              {log.homework ? (
                <span
                  className={`inline-flex items-center justify-center w-full px-2 py-1.5 text-xs font-semibold rounded-full border-2 ${scoreColor(log.homework)}`}
                >
            ...
            <div className="space-y-2">
              ...
              {log.focus ? (
                <span
                  className={`inline-flex items-center justify-center w-full px-2 py-1.5 text-xs font-semibold rounded-full border-2 ${scoreColor(log.focus)}`}
                >
